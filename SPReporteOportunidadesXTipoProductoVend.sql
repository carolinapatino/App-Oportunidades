 CREATE PROC ReporteOportunidadesXTipoProductoVend (@tipoProducto INT, @aPartirDe DATE, @idCreador INT, @idVendedor INT)
 AS 
 BEGIN 
 IF @TipoProducto = 1 
 BEGIN
 ...
 O.CodigoCliente,O.NombreCliente, O.IdCreador, O.IdVendedor, STRING_AGG (P.ProductoId, ',') AS Productos
